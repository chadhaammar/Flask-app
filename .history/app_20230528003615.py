...
def login():
    ...
    if request.method=='POST':
        if (request.form['login'] != '0000' or request.form['password'] != '00') and (request.form['login'] != 'yahya' or request.form['password'] != 'yahya') and (request.form['login'] != 'ghofrane' or request.form['password'] != 'ghofrane') :
            error='INVALIDE'
        else:
