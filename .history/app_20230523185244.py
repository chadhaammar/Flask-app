pytfrom flask import Flask, render_template, request , url_for , session , redirect
import os
...
def login():
    ...
    if request.method=='POST':
        if (request.form['login'] != 'admin' or request.form['password'] != 'admin') and (request.form['login'] != 'yahya' or request.form['password'] != 'yahya') and (request.form['login'] != 'ghofrane' or request.form['password'] != 'ghofrane') :
            error='INVALIDE'
        else:
